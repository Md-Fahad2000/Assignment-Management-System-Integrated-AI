...
public class RoadmapStepDto
{
    ...
    /// <summary>How to do this step (1-2 sentences).</summary>
    public string? step_detail { get; set; }
    public string suggested_date { get; set; } = ""; // YYYY-MM-DD
    public string suggested_time { get; set; } = ""; // HH:mm (start)
    public string? suggested_end_time { get; set; }  // HH:mm (end) — "9:00 to 11:00"
}
